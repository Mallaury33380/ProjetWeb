...
function paiement()
{
	...
	<form method=post action=validationPaiement.php>
        <div>
        	<img width=100px heigh=200px src="images/outils/cartesPaiement.jpg">
            <p>Paiement sécurisé</p>
    	</div>
        <div>
            <label>Adresse de livraison:</label> <input type=text name=adresse placeholder="2 impasse du pain perdu"/>
        </div>
        <div>
            <label>Code postal:</label> <input type=text name=codePostal placeholder="99666"/>
        </div>
        <div>
			<label>Ville:</label><input type=text name=ville placeholder="Paris"/>
        </div>
        <div>
            <label>Titulaire de la carte:</label><input type=text name=titulaire />
        </div>
    	<div>
        	<label>Numéro de la carte:</label><input type=number name=numeroCarte min="0" max="9999999999999999" placeholder="0000000000000000"/>
		</div>
        <div>
        ...
        <div>
			<label>Cryptogramme:</label><input type=number name=cryptogramme min="0" max="999" placeholder="0"/>
		</div>
        <div>
